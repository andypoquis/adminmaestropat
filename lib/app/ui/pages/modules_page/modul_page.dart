...
class ModulPage extends GetView<ModulesController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          controller.isEditing.value ? 'Editar Modulo' : 'Nuevo Modulo',
        ),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              inputWidget('Descripción', controller.descriptionController,
                  controller.unitdescriptionFocused, context),
            ],
          ),
        ),
      ),
